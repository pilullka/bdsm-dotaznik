        ...
        <form method="POST" action="send_attachments.php" enctype="multipart/form-data">
            ...
            <section class="form-group col-sm-12">
                <div class="row">
					...
					<div class="col-sm-3 offset-2 ">
                        <label for="foto_tetovania" class="col-sm-12 control-label">Možnosť priložiť foto /dobrovolné/
                        </label>
                    </div>
                    <div class="col-sm-7">
            ...
            <section class="form-group col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-3 offset-2 ">
                        <label for="foto_piersingu" class="col-sm-12 control-label">Možnosť priložiť foto /dobrovolné/
                        </label>
                    </div>
                    <div class="col-sm-7">
