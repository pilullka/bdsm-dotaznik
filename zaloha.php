  ...
  <?php if (isset($_POST["dotaznik1"]) || isset($_POST["dotaznik2"]) || isset($_POST["dotaznik3"])) { ?>
    <body>
        ...
        <form method="POST" action="send.php">
            ...
            </div><br><div class="form-group col-sm-12">
                <div class="row">
                    <div class="col-sm-5">
           ...
           <div class="form-group col-sm-12">
             ...
             <div class="form-group col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="row">
                            <div class="col-md-3 ">
                                <label><input class="form-check-input" id="B/D" type="radio" value="B/D" name="preferencia">&nbsp;B/D</label>
                            </div>
                            <div class="col-md-4">
            ...
            <div class="form-group col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <input class="form-check-input" type="radio" value="mám" name="otazka3">&nbsp;mám
                        <input class="form-check-input" type="radio" value="nemám" name="otazka3">&nbsp;nemám
                    </div>
                </div>
            </div>
            <div class="form-group col-sm-12">
                <div class="row">
                    <div class="col-sm-3  offset-2">
                        <label for="pocet" class="col-sm-12 control-label">Koľko krát?</label>
                    </div>
                    <div class="col-sm-7">
                        <label for=""><input class="form-control" type="text" name="T1" size="20"></label>
                    </div>
                </div>
            </div>
            <div class="form-group col-sm-12">
...
echo " 
    ...
    <div class=\"container\">
      <div class=\"mt-4 p-5 rounded\"></div>
