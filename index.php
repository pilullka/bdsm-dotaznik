         ...
         <div class="row">
            <div class="col-md-12 mt-5 text-center rounded ">
				...
				elseif (isset($_POST["dotaznik2"])){
					echo "<h1>Rozšírený základný dotazník subinky</h1>";}    
        ...
        <form method="POST" action="send_attachments.php" enctype="multipart/form-data">
            ...
            <section class="form-group col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="prezyvka" name="prezyvka" placeholder="aká je Tvoja oblubená prezývka">
                    </div>
                </div>
            </section><br>
            <section class="form-group col-sm-12">
            ...
            <section class="form-group col-sm-12">
                <div class="row">
                    <div class="col-sm-5">
                        <label for="tetovanie" class="col-sm-6 control-label">Má otrok na tele tetovanie? a kde?
                        </label>
                    </div>
                    <div class="col-sm-7">
					...
					<div class="col-sm-4 offset-1 ">
                        <label for="foto_tetovania" class="col-sm-12 control-label">Možnosť priložiť foto tetovania /dobrovolné/
                        </label>
                    </div>
                    <div class="col-sm-7">
                        <input type="file" class="form-control" name="file[]" multiple="multiple" accept="image/png, image/jpeg" title = "Choose a video please" />
                    </div>
                </div>
            </section><br>
            <section class="form-group col-sm-12">
                <div class="row">
                    ...
                    <div class="col-sm-4 offset-1 ">
                        <label for="foto_piersingu" class="col-sm-12 control-label">Možnosť priložiť foto ozdoby /dobrovolné/
                        </label>
                    </div>
                    <div class="col-sm-7">
                        <input type="file" class="form-control" name="file[]" multiple="multiple" accept="image/png, image/jpeg" placeholder="dobrovolné" />
                    </div>
                </div>
            </section><br>
            <section class="form-group col-sm-12">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <div class="row">
                            ...
                            <div class="col-sm-4 col-4 ">
                                <label><input class="form-check-input" id="S/M" type="radio" value="S/M" name="preferencia">&nbsp;S/M</label>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7 ">
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6">
                                <label><input class="form-check-input" type="radio" value="Rozvedený/á" name="otazka6"> Rozvedený/á</label>
                            </div>
                            <div class="col-md-3 col-6">
                                <label><input class="form-check-input" type="radio" value="Druh/dužka" name="otazka6"> Druh/Družka</label>
                            </div>
                        </div>
                    </div>
                </div>
...
echo " 
    ...
    <div class=\"container\">
      <section class=\"mt-4 p-5 rounded\">
       <div class=\"row  justify-content-center align-items-center\">
            <div class=\" col-sm-4   btn-group-vertical justify-content-center align-items-center\">
                ...
                <div class=\"btn btn-group-vertical\">
			        ...
			        <input type=\"submit\" class=\"btn btn-primary btn-lg btn-lock\" name=\"dotaznik2\" value=\"Rozšírený dotazník\">
